...
// Updated: Hardcoded image type to demo how asciify image from buffer
...
module.exports = function asciify (path, second, third, fourth) {
  // Organize arguments
  var opts          = {},
      onSuccess,
      onFailure;
...
var asciify_core = function(path, opts, onSuccess, onFailure) {
  ...
  lwip.open(path, "jpg", function(err, image) {
